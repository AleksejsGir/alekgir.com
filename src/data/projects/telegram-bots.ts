...
export const telegramBots: Project = {
  ...
  fullDescription: "A comprehensive portfolio of 23 production-ready Telegram bots built for diverse business needs over 3 years of freelance development. Includes solutions for customer engagement, workflow automation, and business process management.\n\nKey features include 15 automated notification systems and 8 complex multi-functional platforms with payment processing, FSM conversation flows, admin dashboards with Django, and scheduled broadcasts.\n\nTechnical highlights: async Python with aiogram and python-telegram-bot libraries, PostgreSQL for state persistence with SQLAlchemy ORM, Redis for caching, and Docker deployment with webhook-based architecture handling thousands of daily interactions.",
