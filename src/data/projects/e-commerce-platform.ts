...
export const eCommercePlatform: Project = {
  ...
  fullDescription: "A high-performance e-commerce single-page application built with React and FastAPI. Designed for handling payment processing and high-traffic loads with async Python backend.\n\nKey features include comprehensive product catalog with advanced filtering, real-time inventory tracking, shopping cart with Redux state management, and secure Stripe payment integration.\n\nTechnical highlights: async FastAPI with Pydantic validation, PostgreSQL with asyncpg driver, Redis caching reducing database load by 60%, and responsive TypeScript frontend achieving 95+ Lighthouse score.",
