...
export const clientPortfolioBundle: Project = {
  ...
  fullDescription: "A curated portfolio of 12 professional websites delivered for freelance clients over 3 years. Each project built with Django server-side rendering for optimal SEO performance and fast time-to-market.\n\nKey features include responsive layouts with Bootstrap 5 and Tailwind CSS, Django forms for contact and lead generation with reCAPTCHA protection, custom CMS integration for client content management, and Google Analytics integration.\n\nTechnical highlights: reusable Django template system with inheritance reducing development time by 40%, comprehensive SEO optimization achieving 90+ average Lighthouse scores, and automated deployment workflows with proper SSL configuration.",
